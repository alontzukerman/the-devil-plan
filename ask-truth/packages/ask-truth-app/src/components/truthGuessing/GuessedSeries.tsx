...
export const GuessedSeries: React.FC<GuessedSeriesProps> = ({
    ...
    return (
        <div className="mb-6 w-full max-w-3xl">
            ...
            <div className="min-h-[8rem] flex items-center justify-center p-2 bg-neutral-700 bg-opacity-50 backdrop-blur-sm rounded-lg border-2 border-primary-500 space-x-1 overflow-x-auto shadow-lg">
